...
import {
    ...
    AlertCircle, Clock, CheckCircle2, Minus, Filter, FileText
} from 'lucide-react';
        ...
        <div className="min-h-screen bg-background p-4 sm:p-6">
            ...
            {emailModal && (
                <EmailModal
                    proyecto={emailModal}
                    draft={{
                        subject: invoiceDraft?.subject || DEFAULT_EMAIL_SUBJECT(emailModal),
                        body: invoiceDraft?.body || DEFAULT_EMAIL_TEMPLATE(emailModal),
                        file: invoiceDraft?.file,
                    }}
                    title={invoiceDraft ? 'Enviar Factura' : 'Enviar correo'}
                    icon={invoiceDraft ? FileText : Mail}
                    onSend={(payload) => synapseService.sendCockpitEmail(payload)}
